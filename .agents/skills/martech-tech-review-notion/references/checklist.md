...
## Structure
- B: all 8 sections present, exact order, exact titles
...
## Section 3 — MarTech Impact
- B: ≥1 surface must be selected
- C: "Other" without a short name
- B: impact summary blank

## Section 4 — Data / System Flow
- C: any flag Yes without a linked technical design in §7
- C: flags missing / ambiguous wording

## Section 5 — Data Quality Evidence
...
- C: N/A status claimed while any §4 flag is Yes
- C: Amber without reason

## Section 6 — What Needs MarTech Review?
...
## Checklist usage
The unchecked boxes in this file are reviewer-side markers, NOT the doc's §3/§6 on-off syntax. Do not paste them into a doc; do not read uncomputed checklists as unmet blockers.
